...
slides.delay =  slide({ //check this!!!
  ...
  button : function(){
    ...
    if($("#delay1").val() == ""|$("#delay2").val() == ""|$("#delay3").val() == "") {
      $(".err").show();
...
function sendDataToServer(data) {
	$.ajax({
    url: 'https://script.google.com/macros/s/AKfycbwspEkUcypBHehnKEr6pZKcDThOalubq3tGhYciSI_xGlOBRvv1oDnvUfEVm2F5Nnif/exec',
		type: 'post',
    data: data,
    complete: function(){
      window.location.replace("https://app.prolific.co/submissions/complete?cc=D24C2ECB") // redirect to prolific
    } 
	});
}
